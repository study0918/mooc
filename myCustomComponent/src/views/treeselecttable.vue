...
export default {
  ...
  mounted() {
    ...
    // console.log('copyContentSetLinearTable', JSON.stringify(this.copyContentSetLinearTable, null, 4))
    console.log(JSON.stringify(this.copyContentSetMinList))
    // console.log(this.copyContentSetLinearTable === this.copyContentTableDisplay)
  },
  methods: {
