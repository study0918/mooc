...
// https://blog.csdn.net/qq_32442967/article/details/103072390
import selectTable from '@/views/selectTable'
import selectTreeTable from "@/views/selectTreeTable"
import treeNode from '@/views/treeTable/treeNode'
import attrs from '@/views/attrs/father'
import selfAdaption from  '@/views/selfAdaption'
import suitdemo from  '@/views/suitdemo/index2'
Vue.use(Router)
...
export default new Router({
  routes: [{
    ...
    {
      path:'/selectTreeTable',
      name: 'selectTreeTable',
      component: selectTreeTable
    },
    {
      path:'/treeNode',
      name:'treeNode',
